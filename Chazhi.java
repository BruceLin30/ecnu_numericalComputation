...
public class Chazhi extends JFrame
{    
	Draw draw;
	MyPanel paint;
	public Chazhi()
	{
		...
		draw = new Draw();
		paint = new MyPanel();
		paint.addMouseListener(new Press(this));
		getContentPane().setLayout(new BorderLayout());
		JPanel ButtonBar = new JPanel();
		ButtonBar.setLayout(new GridLayout(1,3));
		
		JButton Lagrange = new JButton("�������ղ�ֵ");
		JButton Newton = new JButton("ţ�ٲ�ֵ");
		JButton Thrice = new JButton("������Ȼ����");
...
class Draw
{
	...
	int number = 0;
	int choice = 0;
	public void get(MyPanel a)
	{
		g = a.getGraphics();
	}
	
	public void Lagrange()//�������ղ�ֵ�㷨
	{
...
class Button implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(btn.getText().equals("�������ղ�ֵ"))
		{
			abc.choice = 1;
		}
		else if(btn.getText().equals("ţ�ٲ�ֵ"))
		{
			abc.choice = 2;
		}
		else if(btn.getText().equals("������Ȼ����"))
		{
			abc.choice = 3;
		}
